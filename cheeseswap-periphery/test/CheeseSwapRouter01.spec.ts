...
enum RouterVersion {
  CheeseSwapRouter01 = 'CheeseSwapRouter01',
  CheeseSwapRouter = 'CheeseSwapRouter'
}

describe('CheeseSwapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.CheeseSwapRouter01]: fixture.router01,
        [RouterVersion.CheeseSwapRouter]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.CheeseSwapRouter01]: 101876,
              [RouterVersion.CheeseSwapRouter]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.CheeseSwapRouter01]: 138770,
              [RouterVersion.CheeseSwapRouter]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
